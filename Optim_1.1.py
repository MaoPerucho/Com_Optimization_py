...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug  9 14:43:10 2022

@author: hedinyer
"""

#new method to develop an incredible optimization!!!
...
#5-plot all the data (it's ok, not the same as matlab but ok)
######################################
...
upper_region_array =  m[0]*0.1/100 + m[0]
lower_region_array = -m[0]*0.1/100 + m[0]
...
#7.5-plot the cut region (total)
##########################

cut_f2 = np.array(cut_f2)
cut_array2 = np.array(cut_array2)
plt.plot(cut_f2,cut_array2,"*")
plt.plot(f,s_i)
plt.show()
...
#second x0
x0 = np.array([K12,Zeta,Gamma_1,Gamma_2,Vs,C])
# Bounds for the 2 principal models
bnds = ((0.1, 0.1), (0.1, 2000), (0.1,2000), (0.1,2000), (0.1,1457) ,(1e-15,1e-2))
